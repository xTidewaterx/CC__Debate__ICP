...
console.log("likeIDproblem",param)
...
//....
    ...
    return <div className='organismBattlefield__Like'>{likeCount} <button  onClick= {() => likeFunction ()}>Like</button></div>
