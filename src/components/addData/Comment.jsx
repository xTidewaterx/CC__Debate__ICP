...
setState("")
    ...
    return (
    <div className='App__CommentContainer'>
    <textarea className='App__CommentContainerInput' placeholder='Got a controversial take?' value={state} onChange={(e) => {setState(e.target.value)}}/>
    
    <button className='AppCommentContainerButton' onClick={() => {commentFunction()}}>Post </button></div>
  )
}
