        ...
        correctID =docRef.id;
          ...
          //right after we do this, unique ID ther will be regardless, id and then sorted, parentId
            await updateDoc(docRef, {
              ID: docRef.id,
            }).then(console.log("id updated")).then(
...
const modifiedObject = {...data, ID: correctID}

console.log("oranges::", modifiedObject)


   //Object.assign(data.ID=correctId);
    
  console.log("oranges::", data)
    ...
    console.log(docRef)
              setInputValue("")
                   console.log(
                    ...
                    const  newArray =  [...organismObject.stateValue?.state, modifiedObject]
  ...
  return (
    <div className="organismBattlefield__Reply">
      ...
      <input
      style={{display: displayBoolean ? "block" : "none"}}
      placeholder="reply..."
        value={inputValue}
        onChange={(e) => {
